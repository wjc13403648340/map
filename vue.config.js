...
module.exports = {
  ...
  devServer: {
    ...
    hotOnly: false,
    proxy: {
      '/oilSearch':{//axios访问 /api == target + /api
        　target:'http://10.82.5.140:58888',
      ...
      // http://10.82.5.140:58888/oilSearch/OilSearch.asmx/GetNewestGt 
      '/webservice':{//axios访问 /api == target + /api
        　target:'http://10.82.5.140:58888',
        　changeOrigin:true,//创建虚拟服务器
          ws:true,
          pathRewrite:{
